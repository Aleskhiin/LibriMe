...
const TRANSLATIONS: Record<UiLanguage, Translations> = {
  de: {
    ...
    appUploadLimit: 'Upload-Limit: {limit} MB',
    ...
    landingCta: 'Zur App',
    authContinueTitle: 'Anmelden oder registrieren',
    authMenuLabel: 'Account',
    authLogin: 'Login',
    authContinueGoogle: 'Mit Google fortfahren',
    authEmail: 'E-Mail-Adresse',
    authPassword: 'Passwort',
    authSignInEmail: 'Mit E-Mail anmelden',
    authSignUpEmail: 'Mit E-Mail registrieren',
    authEmailPasswordHint: 'Oder E-Mail und Passwort verwenden',
    authOpenApp: 'Zur App',
    authContinueAnonymous: 'Ohne Anmeldung zur App',
    authAnonymousLimit: 'Anonym nutzbar mit 10 MB Upload-Limit.',
    authLogout: 'Abmelden',
    authSignedInAs: 'Angemeldet als {name}',
    authLoginFailed: 'Anmeldung fehlgeschlagen.',
    landingUploadTitle: 'Dokumente hochladen',
    landingUploadText: 'Einfach per Drag & Drop oder Dateiauswahl, mit höherem Limit nach Anmeldung.',
    ...
    landingReadyText: 'Jobstatus verfolgen und das fertige Hörbuch direkt herunterladen.',
    ...
    uploadTooLargeWithLimit: 'Die Datei darf maximal {limit} MB groß sein.',
  ...
  en: {
    ...
    landingCta: 'Open app',
    authContinueTitle: 'Sign in or create account',
    authMenuLabel: 'Account',
    authLogin: 'Login',
    ...
    authEmailPasswordHint: 'Or use email and password',
    authOpenApp: 'Open app',
    authContinueAnonymous: 'Continue without sign-in',
    authAnonymousLimit: 'Use anonymously with a 10 MB upload limit.',
    authLogout: 'Logout',
    authSignedInAs: 'Signed in as {name}',
    authLoginFailed: 'Sign-in failed.',
    landingUploadTitle: 'Upload documents',
    landingUploadText: 'Use drag & drop or file selection, with a higher limit after sign-in.',
    ...
    landingReadyText: 'Track the job status and download the finished audiobook directly.',
    ...
    uploadTooLargeWithLimit: 'The file must be {limit} MB or smaller.',
