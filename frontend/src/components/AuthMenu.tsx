...
export default function AuthMenu() {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 z-20 mt-2 w-72 rounded-xl border border-orange-100 bg-white/95 p-3 text-left shadow-lg shadow-orange-900/10 backdrop-blur-sm">
          {user ? (
